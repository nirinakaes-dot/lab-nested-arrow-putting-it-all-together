...
console.log(attemptCount)
    if(passwordAttempt === userInfo.password && attemptCount<=3) {return "Login succesfull"} else if(attemptCount<=3){return `Attempt${attemptCount}:Login failed`} else{ return "Account locked due to too many failed login attempts"}
